...
const HomePage = () => {
    return (
        <Box sx={{
            ...
            <Box component="div" sx={{ background: "transparent", width: {xs: "80%", sm: "60%"}, padding: "50px 15px 50px", height: {xs: "150px" , sm: "200px"}, backdropFilter: "blur(5px)", borderRadius: "20px", boxShadow: "0 0 10px #000" }}>
                <TypingAnimation />
            </Box>
        </Box>
    )
